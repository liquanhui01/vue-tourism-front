...
Vue.directive('dialogDrag', {
	...
	bind(el, binding, vnode, oldVnode) {
		...
		dragDom.onmousemove = function(e) {
			...
			if (e.clientX > dragDom.offsetLeft + dragDom.clientWidth - 10 || dragDom.offsetLeft + 10 > e
				.clientX) {
			...
			dragDom.onmousedown = (e) => {
				...
				if (clientX > EloffsetLeft && clientX < EloffsetLeft + elW && clientY > EloffsetTop &&
					...
					document.onmousemove = function(e) {
						...
						if (ELscrollTop + clientY > EloffsetTop + elH - 20 && ELscrollTop +
							clientY < EloffsetTop + elH) {
